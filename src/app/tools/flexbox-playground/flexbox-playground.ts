            ...
            <div class="grid grid-cols-2 gap-1.5 font-mono text-[11px]">
              @for (dir of ['row', 'row-reverse', 'col', 'col-reverse']; track dir) {
                <button 
                  ...
                  class="p-2 border border-zinc-800 rounded-lg hover:border-zinc-700 bg-zinc-900/60 font-bold transition lowercase"
                >
          ...
          <div class="pt-3 border-t border-zinc-850/60 flex items-center justify-between text-xs font-mono">
            ...
            <div class="flex items-center gap-1.5">
              <button 
                ...
                class="w-6 h-6 flex items-center justify-center border border-zinc-800 rounded hover:border-zinc-700 bg-zinc-950 text-zinc-400 disabled:opacity-40"
              >
                -
              </button>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="p-4 bg-zinc-900 border border-zinc-850 rounded-xl text-left space-y-2">
              <div class="flex items-center justify-between font-mono">
                ...
                <button 
                  (click)="copyTailwind()"
                  class="p-1 text-emerald-400 hover:text-emerald-300 hover:bg-emerald-950/20 rounded transition flex items-center gap-1 font-mono text-[10px]"
                >
            ...
            <div class="p-4 bg-zinc-900 border border-zinc-850 rounded-xl text-left space-y-2">
              <div class="flex items-center justify-between font-mono">
                ...
                <button 
                  (click)="copyCss()"
                  class="p-1 text-sky-400 hover:text-sky-300 hover:bg-sky-950/20 rounded transition flex items-center gap-1 font-mono text-[10px]"
                >
                  <mat-icon class="scale-50">content_copy</mat-icon>
